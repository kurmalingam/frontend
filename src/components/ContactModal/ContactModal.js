          ...
          <div className="modal-body p-0">
            <div className="container-fluid">
              <div className="row g-0 flex-column flex-lg-row">
                {/* Left: Info */}
                <div className="col-12 col-lg-6 contact-info-section p-3">
                  ...
                  <div className="contact-item bg-light-green p-2 rounded mb-2">
                    ...
                    <span className="fs-6">+91 98765 43210</span>
                  </div>
                  <div className="contact-item bg-light-green p-2 rounded mb-2">
                    <i className="bi bi-envelope-fill text-dark-green fs-6"></i>
                    <span className="fs-6">drypanda@gmail.com</span>
                  </div>
                  <div className="contact-item bg-light-green p-2 rounded mb-2">
                ...
                <div className="col-12 col-lg-6 p-3">
                  ...
                  <form onSubmit={(e) => { e.preventDefault(); alert('Message sent!') }}>
                    ...
                    <button type="submit" class="btn btn-dark-green w-100 py-2 d-flex align-items-center justify-content-center gap-2">
